...
public class InputVCR : MonoBehaviour
{
    ...
    public void SyncPosition()
    {
        ...
        SyncProperty("position VR", Vector3ToString(transform.position));
        SyncProperty("rotation VR", Vector3ToString(transform.eulerAngles));
    ...
    public void SaveRecording()
    {
        ...
        string path = null;
        string filename = "/Recording_" + jsonRecordingName + "_R" + currentRun + "_S" + currentStage + "_M" + currentMultiplier + "_" + System.DateTime.Now.ToString("HH-mm-ss__MM-dd-yyyy") + ".json";
        path = "MyGame_Data/Resources" + filename;

        string str = savedRecording.ToString();
    ...
    {
        Application.OpenURL(jsonRecording);
