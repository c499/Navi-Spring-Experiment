...
namespace VRTK
{
    ...
    public class VRTK_InteractGrab : MonoBehaviour
    {
        ...
        private GameObject grabbedObject = null;    //Object we are grabbing
        ...
        {
            //Handler to receive the messages produced when we grab something
        ...
        public virtual void OnControllerUngrabInteractableObject(ObjectInteractEventArgs e)
        {
            ...
            var nc = GameObject.FindObjectOfType<NavigationControl>();
            nc.OnInteractableObjectUngrab(e);
        }
        ...
        public void ForceRelease()
        {
            ...
            {   //Behaviour for objects with a VRTK_InteractableObject script attached (SHOULD NOT BE USED IN OUR PROJECT)
                UngrabTrackedObject();
            }
            else
            {   //Behaviour for other objects...
